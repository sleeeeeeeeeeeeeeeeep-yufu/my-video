...
const calculateMetadata: CalculateMetadataFunction<z.infer<typeof CompositionProps>> = ({ props }) => {
  return {
    durationInFrames: props.meta?.durationInFrames || episode.meta.durationInFrames || 2940,
  ...
  return (
    <>
      <Composition
        id={COMP_NAME}
        component={Main}
        durationInFrames={episode.meta.durationInFrames || 2940}
        ...
        defaultProps={{ ...defaultMyCompProps, ...episode, cuts: (episode as any).cuts || [] } as any}
